...
function ProductForm() {
  ...
  return (
    <div style={{background: "white", padding: "2rem", borderRadius: "12px", boxShadow: "0 4px 12px rgba(15, 30, 58, 0.12)", maxWidth: "600px", margin: "0 auto", border: "1px solid #e2e8f0"}}>
      <h2 style={{color: "#0f1e3a", marginBottom: "1.5rem", fontSize: "1.5rem", fontWeight: "800"}}>Add New Product</h2>
